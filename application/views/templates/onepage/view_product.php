        ...
        <div class="row">
            ...
            <div class="col-sm-8">
                ...
                <div class="row row-info">
                    ...
                    <div class="col-sm-6">
                        <a href="javascript:void(0);" class="go-category btn btn-info" data-categorie-id="<?= $product['shop_categorie'] ?>">
                ...
                <div class="row row-info">
                    ...
                    <div class="col-sm-6 manage-buttons">
                        <?php if ($product['quantity'] > 0) { ?>
                            <a href="javascript:void(0);" data-id="<?= $product['id'] ?>" data-goto="<?= LANG_URL . '/checkout' ?>" class="add-to-cart btn-add btn btn-info">
                                <span class="text-to-bg"><?= lang('buy_now') ?></span>
                            </a>
                            <a href="javascript:void(0);" data-id="<?= $product['id'] ?>" data-goto="<?= LANG_URL . '/shopping-cart' ?>" class="add-to-cart btn-add btn btn-info">
